...
import {
    ...
    MenuIcon as Bars3CenterLeftIcon,
                  ...
                  <span className="flex w-full items-center justify-between">
                    ...
                    />
                      ...
                      />
                                    ...
                                    <a href={categories[0].href} className="group flex items-center rounded-md px-3 py-2 text-xs font-medium text-gray-500 hover:bg-gray-50 hover:text-gray-900">
                                        <span >
                    ...
                    <div className="sticky top-0 z-10 flex h-16 flex-shrink-0 border-b border-gray-200 bg-white lg:hidden">
                        ...
                        <div className="flex flex-1 justify-between px-4 sm:px-6 lg:px-8">
                            <div className="flex flex-1">
                                <form className="flex w-full md:ml-0" action="api#" method="GET">
